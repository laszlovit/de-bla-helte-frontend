...
export function SidebarLayout({
	...
	return (
		<div className="relative isolate flex min-h-svh w-full bg-white text-zinc-950 max-lg:flex-col lg:bg-zinc-100 dark:bg-zinc-900 dark:text-white dark:lg:bg-zinc-950">
			{/* Sidebar on desktop */}
